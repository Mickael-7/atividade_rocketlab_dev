    ...
    <>
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <nav className="flex items-center gap-2 text-sm text-gray-500">
          ...
          <span className="text-gray-900 font-medium truncate">{produto.nome_produto}</span>
        </nav>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
          <div className="flex flex-col md:flex-row">
            {/* imagem */}
            <div className="md:w-72 h-56 md:h-auto bg-gray-100 shrink-0">
              {imagem ? (
                <img
                  src={imagem}
            ...
            <div className="p-6 flex flex-col gap-3 flex-1">
              <div className="flex items-start justify-between gap-4 flex-wrap">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  <Link
                    ...
                    className="inline-flex items-center gap-1.5 px-4 py-2 text-sm font-medium text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-lg transition"
                  >
                    <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              <p className="text-xs text-gray-400 font-mono">ID: {produto.id_produto}</p>
            </div>
          </div>
        </div>
        ...
        {/* vendas */}
        <section>
          <h2 className="text-lg font-semibold text-gray-900 mb-3">Desempenho de Vendas</h2>
